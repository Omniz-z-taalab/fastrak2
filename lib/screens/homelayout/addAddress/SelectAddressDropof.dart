...
class SelectAddressDropof extends StatefulWidget {
  // List<UserAddress> SelectDropof;
  // SelectAddressDropof(this.SelectDropof);
  @override
  State<SelectAddressDropof> createState() => _SelectAddressDropofState();
}

class _SelectAddressDropofState extends State<SelectAddressDropof> {
  UserAddress statee;
  String name;
  String buildNumber;
  String fullAddress;
                                    ...
                                    Container(
                                      ...
                                      child: Material(
                                          child: Padding(
                                            ...
                                            child: ListTile(
                                              trailing: Icon(Icons.check_circle_outline,color: Colors.grey.shade400,),
                                              title: Text(
                                                Add[index].address,
                                                style: TextStyle(
                                                  fontSize: 15,
